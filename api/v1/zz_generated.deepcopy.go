...
func (in *HostSystemdUnit) DeepCopyInto(out *HostSystemdUnit) {
	*out = *in
	if in.Config != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HostSystemdUnit.
func (in *HostSystemdUnit) DeepCopy() *HostSystemdUnit {
	if in == nil {
		return nil
	}
	out := new(HostSystemdUnit)
	in.DeepCopyInto(out)
	return out
}
...
func (in *UnitSpec) DeepCopyInto(out *UnitSpec) {
	*out = *in
	out.Job = in.Job
	in.HostUnit.DeepCopyInto(&out.HostUnit)
}
...
func (in *UnitStatus) DeepCopyInto(out *UnitStatus) {
	*out = *in
	in.ExecTimestamp.DeepCopyInto(&out.ExecTimestamp)
}
